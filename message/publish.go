...
type protochainCreate struct {
	enc *protochain.Encoder
	// TODO: hmac         *[32]byte
	// TODO setTimestamp bool
}

func (pc protochainCreate) Create(val interface{}, prev *ssb.MessageRef, seq margaret.Seq) (ssb.Message, error) {
	var br *protochain.BinaryRef
	if prev != nil {
		var err error
		br, err = protochain.NewBinaryRef(prev)
		if err != nil {
			return nil, err
		}
	}
	...
	if err != nil {
		return nil, errors.Wrap(err, "protochain: failed to encode content")
	}
	return tr, nil
}
